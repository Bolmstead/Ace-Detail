...
import { usaRed } from "vars";

import Container from "components/Container";
import FixedLayout from "layouts/Fixed";
import { dark as darkPalette, light as lightPalette } from "theme/palette";
              ...
              <Grid container spacing={2}>
                {[
                  ...
                  <Grid item xs={12} sm={3} key={i}>
                    <Box component={Card} boxShadow={3} borderRadius={2}>
                      <Box width={1} height={200} bgcolor={"yellow"} />
                      <CardContent>{"yellow"}</CardContent>
                    </Box>
                  </Grid>
                ))}
              </Grid>
